...
export default function ReconstitutionCalculator({
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        <p className="text-xs leading-relaxed mb-5" style={{ color: 'var(--text-mid)' }}>
        ...
        {result && (
          ...
          >
            ...
            <div
              className="grid grid-cols-2 gap-3 pt-3 text-xs"
            ...
            >
              <div>
                ...
                <p className="font-semibold tabular-nums" style={{ color: 'var(--navy)' }}>
            ...
            {result.isOverDraw && (
              <p className="text-[11px] mt-3 leading-snug" style={{ color: '#991B1B' }}>
  ...
  return (
    <div>
      <label className="flex items-center justify-between mb-1.5">
        <span className="text-xs font-semibold" style={{ color: 'var(--navy)' }}>{label}</span>
        <span className="text-[10px] font-medium" style={{ color: 'var(--text-light)' }}>{unit}</span>
      </label>
      <input
        type="number"
        value={value}
        ...
        step={step}
        min={min}
        className="w-full px-3 py-2 rounded-lg text-sm font-semibold tabular-nums outline-none transition-colors"
        style={{
