        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="group">
              ...
              >
                <span className="absolute left-4" style={{ color: 'var(--text-light)' }}>
                ...
                <input
                  ...
                  style={{ paddingLeft: '2.75rem', paddingRight: '3rem', color: 'var(--text-dark)' }}
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((s) => !s)}
                  className="absolute right-3 p-1 rounded transition-colors"
                  style={{ color: showPassword ? 'var(--gold)' : 'var(--text-light)' }}
                  tabIndex={-1}
                >
                  <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {showPassword ? (
            ...
            <div className="group">
              ...
              >
                ...
                <input
                  ...
                  className="w-full py-3.5 text-sm bg-transparent focus:outline-none"
                  style={{ paddingLeft: '2.75rem', paddingRight: '1rem', color: 'var(--text-dark)' }}
                />
              </div>
            </div>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: loading ? 'none' : '0 4px 20px rgba(200,149,44,0.35)',
