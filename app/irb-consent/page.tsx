...
export const metadata: Metadata = {
  title: 'IRB Peptide Pure Ordering Consent',
  description:
    'Site Participant Consent for the IRB-approved observational registry operated by Mortensen Medical Research Network.',
  alternates: { canonical: '/irb-consent' },
};

export default async function IrbConsentPage() {
  const content = await getContent<PolicyPageContent>('irb-consent');
