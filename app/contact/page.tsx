    ...
    <>
      ...
      <section className="py-20" style={{ background: 'var(--navy)' }}>
        <div className="container-xl text-center">
          <span className="section-label text-yellow-300">Get In Touch</span>
          <h1 className="text-3xl md:text-5xl font-bold text-white mt-2 mb-4">Contact Us</h1>
          <p className="text-gray-300 max-w-xl mx-auto">
            Our team is available Monday–Friday, 9AM–4PM PST. We typically respond within one business day.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm leading-relaxed" style={{ color: 'var(--text-mid)' }}>
                  Whether you need help with account setup, protocol questions, or ordering — our team of peptide specialists is ready to assist licensed clinicians.
                </p>
              </div>
              ...
              <div className="p-5 rounded-2xl" style={{ background: 'var(--navy)' }}>
                <p className="text-xs text-gray-300 leading-relaxed">
                  <strong className="text-white">Access Note:</strong> PeptidePure™ is a clinician-only platform. To request account access, please provide your NPI number and professional credentials in the form.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-sm" style={{ border: '1px solid var(--border)' }}>
                  <h3 className="text-xl font-bold mb-6" style={{ color: 'var(--navy)' }}>Send a Message</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option>ND</option>
                        <option>DC</option>
                        <option>Qualified Researcher</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-xs font-semibold uppercase tracking-wide mb-1.5" style={{ color: 'var(--text-mid)' }}>
                  ...
                  <p className="text-xs text-center mt-4" style={{ color: 'var(--text-light)' }}>
                    By submitting this form, you confirm that you are a licensed healthcare professional.
                  </p>
                </form>
              )}
            </div>
