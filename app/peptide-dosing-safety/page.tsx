...
export default async function PeptideDosingPage() {
  ...
  return (
    <>
        ...
        <div className="container-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {reconstitutionSteps.steps.map((step: { num: string; title: string; desc: string }) => (
              ...
              >
                <div className="text-4xl font-bold mb-3" style={{ color: 'var(--gold)', fontFamily: 'var(--font-display)', opacity: 0.6 }}>
                  {step.num}
                </div>
      ...
      {/* U-100 Conversion Rule */}
      <section className="py-14" style={{ background: 'var(--gold-pale)' }}>
        <div className="container-xl">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4" style={{ color: 'var(--text-dark)' }}>
              {conversionRule.heading}
            </h2>
            <p className="text-lg leading-relaxed mb-6" style={{ color: 'var(--text-mid)' }}>
              {conversionRule.body}
            </p>
            <div
              className="inline-block px-8 py-4 rounded-2xl font-mono text-lg font-semibold"
              style={{ background: 'white', color: 'var(--navy)', border: '2px solid var(--gold)', boxShadow: 'var(--shadow-gold)' }}
            >
      ...
      <section className="py-16" style={{ background: 'var(--surface)' }}>
        <div className="container-xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mt-2" style={{ color: 'var(--text-dark)' }}>
              Peptide Dosing Reference
            </h2>
            <p className="mt-3 max-w-xl mx-auto" style={{ color: 'var(--text-mid)' }}>
              Example reconstitution and dosing parameters. Always confirm with your clinical protocol.
            </p>
          </div>
