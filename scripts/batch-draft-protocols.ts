...
const TOPICS: Topic[] = [
  ...
  { title: 'Sema + Cagrilintide Synergy Stack', slug: 'sema-cagrilintide-synergy', category: 'Metabolism/Weight Loss', peptides: ['Sema 15mg', 'Cagrilintide 5mg', 'Cagrilintide 10mg'], summary: 'GLP-1 + amylin co-agonist stack for plateau-busting in Sema-responsive patients.' },
